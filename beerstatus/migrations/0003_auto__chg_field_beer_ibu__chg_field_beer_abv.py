...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'beerstatus_beer', 'ibu', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Beer.abv'
        db.alter_column(u'beerstatus_beer', 'abv', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Beer.ibu'
        db.alter_column(u'beerstatus_beer', 'ibu', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Beer.abv'
        db.alter_column(u'beerstatus_beer', 'abv', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        u'beerstatus.beer': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'ibu': ('django.db.models.fields.FloatField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
