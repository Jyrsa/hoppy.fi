...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BeerRater.url_base'
        db.add_column(u'beerstatus_beerrater', 'url_base',
                      self.gf('django.db.models.fields.CharField')(default='http://localhost/?q=%s', max_length=400),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BeerRater.url_base'
        db.delete_column(u'beerstatus_beerrater', 'url_base')
