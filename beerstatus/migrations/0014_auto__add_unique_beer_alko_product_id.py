...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Beer', fields ['alko_product_id']
        db.create_unique(u'beerstatus_beer', ['alko_product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Beer', fields ['alko_product_id']
        db.delete_unique(u'beerstatus_beer', ['alko_product_id'])
    ...
    models = {
        ...
        u'beerstatus.beer': {
            ...
            'alko_product_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '6'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
