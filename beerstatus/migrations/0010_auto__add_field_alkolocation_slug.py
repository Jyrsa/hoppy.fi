...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlkoLocation.slug'
        db.add_column(u'beerstatus_alkolocation', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='a', unique_with=(), max_length=50, populate_from='name'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlkoLocation.slug'
        db.delete_column(u'beerstatus_alkolocation', 'slug')
