...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Beer.price'
        db.add_column(u'beerstatus_beer', 'price',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Beer.volume'
        db.add_column(u'beerstatus_beer', 'volume',
                      self.gf('django.db.models.fields.FloatField')(default=0.33),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Beer.price'
        db.delete_column(u'beerstatus_beer', 'price')

        # Deleting field 'Beer.volume'
        db.delete_column(u'beerstatus_beer', 'volume')
    ...
    models = {
        ...
        u'beerstatus.beer': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'ebu': ('django.db.models.fields.FloatField', [], {}),
