...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'beerstatus_beer', 'ibu', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Beer.ibu'
        db.alter_column(u'beerstatus_beer', 'ibu', self.gf('django.db.models.fields.FloatField')(default=0))
