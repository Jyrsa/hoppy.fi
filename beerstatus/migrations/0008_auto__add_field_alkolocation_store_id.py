...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlkoLocation.store_id'
        db.add_column(u'beerstatus_alkolocation', 'store_id',
                      self.gf('django.db.models.fields.CharField')(default=1234, max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlkoLocation.store_id'
        db.delete_column(u'beerstatus_alkolocation', 'store_id')
    ...
    models = {
        u'beerstatus.alkolocation': {
            ...
            'store_id': ('django.db.models.fields.CharField', [], {'default': '1234', 'max_length': '5'})
        },
        u'beerstatus.beer': {
